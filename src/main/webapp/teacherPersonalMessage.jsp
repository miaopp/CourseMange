...
<html ng-app="teacherPersonalMessageModule" ng-controller="teacherPersonalMessageCtrl">
<head>
    ...
    <script type="text/javascript">
        var app = angular.module('teacherPersonalMessageModule', ['ui.bootstrap', 'ngSanitize']);
        app.controller("teacherPersonalMessageCtrl", function ($scope, $http) {
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="./teacherPersonalMessage.jsp">个人信息管理</a></li>
            </ul>
