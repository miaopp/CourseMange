...
<html ng-app="managerPersonalMessageModule" ng-controller="managerPersonalMessageCtrl">
<head>
    ...
    <script type="text/javascript">
        var app = angular.module('managerPersonalMessageModule', ['ui.bootstrap', 'ngSanitize']);
        app.controller("managerPersonalMessageCtrl", function ($scope, $http) {
